export default function GapSec() {
  return (
    <div className="bg-primary px-28 py-4">
      <div className="flex items-center justify-between gap-6 text-white">
        ...
        <p className="text-2xl font-semibold italic">Web Design</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="2em"
          height="2em"
        ...
        <p className="text-2xl font-semibold italic">UI Development</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="2em"
          height="2em"
        ...
        <p className="text-2xl font-semibold italic">Responsive Design</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="2em"
          height="2em"
